...
function createInstructions() {
	...
	text.innerHTML = '<span style="color:' + theme[0] + ';font-size:40px;">嗨!</span><br /><br /><span style="font-size:15px;"><strong>这个游戏超级好玩:</strong><br /><br />1. 拉拽一个球.<br />2.点击或按住空白处<br />3. 摇晃手机或浏览器窗口<br />（不是摇晃你的笔记本:）.<br />4. 双击清空.<br />5. 开始表演吧!</span>';
