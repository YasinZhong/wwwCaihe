...
+ function(window) {
    ...
    IScroll.prototype = {
        ...
        _transitionTime: function(time) {
            ...
            if (!time && utils.isBadAndroid) {
                this.scrollerStyle[utils.style.transitionDuration] = 'http://m.sui.taobao.org/dist/js/0.001s';
            }
    ...
    function Indicator(scroller, options) {
        ...
        if (this.options.fade) {
            ...
            this.wrapperStyle[utils.style.transitionDuration] = utils.isBadAndroid ? 'http://m.sui.taobao.org/dist/js/0.001s' : '0ms';
    ...
    Indicator.prototype = {
        ...
        transitionTime: function(time) {
            ...
            if (!time && utils.isBadAndroid) {
                this.indicatorStyle[utils.style.transitionDuration] = 'http://m.sui.taobao.org/dist/js/0.001s';
            }
        },
...
+ function($) {
    ...
    if($.device.ios){
        ...
        $(document).on($.touchEvents.move, "http://m.sui.taobao.org/dist/js/.page-current .bar",function(){
            event.preventDefault();
        });
        //监听ajax页面跳转
